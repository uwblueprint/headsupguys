...
function alignCommand(children, tag): ReactNode {
    ...
    children[children.length - 1] = children[children.length - 1].slice(
        0,
        -trimVal,
    );

    return (
        <Tag style={{ textAlign: alignStyle as CSS.Property.TextAlign }}>
            {children}
        </Tag>
    );
}
    ...
    <div className="md-row">
        <ReactMarkdown
            components={{
                ...
                h1: ({ children }) => alignCommand(children, "h1"),
